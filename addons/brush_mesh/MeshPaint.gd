...
func _on_tree_entered():
	...
	for instance in multimesh.instance_count:
		var cur_transform = multimesh.get_instance_transform(instance)
		positions.append(cur_transform.origin)
		rotations.append(cur_transform.basis[1])
		scales.append(cur_transform.basis(2))
	updatePos()
